...
library: src/Tensor.cpp src/Shape.cpp  src/CSVReader.cpp src/Dataset.cpp src/Loss.cpp src/Math.cpp src/Optimizer.cpp src/Algorithm.cpp src/Utils.cpp
	...
	@ar rcs lib/libcmind.a obj/Tensor.o obj/Shape.o obj/CSVReader.o obj/Dataset.o obj/Loss.o obj/Math.o obj/Optimizer.o obj/Algorithm.o obj/Utils.o