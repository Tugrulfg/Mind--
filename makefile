...
library: src/Tensor.cpp src/Shape.cpp  src/CSVReader.cpp src/Dataset.cpp src/Loss.cpp src/Math.cpp
	...
	@ar rcs lib/libcmind.a obj/Tensor.o obj/Shape.o obj/CSVReader.o obj/Dataset.o obj/Loss.o obj/Math.o